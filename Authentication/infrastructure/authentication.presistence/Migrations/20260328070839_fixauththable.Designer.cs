...
namespace authentication.presistence.Migrations
{
    ...
    [Migration("20260328070839_fixauththable")]
    partial class fixauththable
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("authentication.domain.User", b =>
                {
                    ...
                    b.Property<int?>("SignitureImageId")
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("authentication.domain.User", b =>
                {
                    b.HasOne("authentication.domain.signitureimage", "SignitureImage")
                        .WithMany()
                        .HasForeignKey("SignitureImageId");

                    b.Navigation("SignitureImage");
                });
